	...
	<div id="tabs">
		...
		<div class="row">
			<div class="twelve columns">
				<div class="six columns">
					...
					<input type="text" name="bill_firstname" id="bill_firstname" class="input-text" placeholder="First Name" value="<?=$clientdata->first_name?>">

				</div>
				<div class="six columns">
					<?=form_label('Last Name', 'bill_lastname');?>
					<input type="text" name="bill_lastname" id="bill_lastname" class="input-text" placeholder="Last Name" value="<?=$clientdata->last_name?>">
		...
		<div class="row">
			<div class="twelve columns">
				<div class="six columns">
					...
					<input type="text" name="bill_company" id="bill_company" class="input-text" placeholder="Company Name" value="<?=$clientdata->company?>">
		...
		<div class="row">
			<div class="twelve columns">
				<div class="six columns">
					...
					<input type="text" name="bill_email" id="bill_email" class="input-text" placeholder="Email Address" value="<?=$clientdata->email?>">
		...
		<div class="row">
			<div class="twelve columns">
				...
				<input type="text" name="bill_street" id="bill_street" class="input-text" placeholder="Street Address" value="<?=$clientdata->street?>">
		...
		<div class="row">
			<div class="twelve columns">
				<div class="six columns">
					...
					<input type="text" name="bill_city" id="bill_city" class="input-text" placeholder="Street Address" value="<?=$clientdata->city?>">

				</div>
				<div class="three columns">
					<?=form_label('State', 'bill_state');?>
					<input type="text" name="bill_state" id="bill_state" class="small input-text" placeholder="State" value="<?=$clientdata->state?>">

				</div>
				<div class="three columns">
					<?=form_label('Zip', 'bill_zip');?>
					<input type="text" name="bill_zip" id="bill_zip" class="small input-text" placeholder="Zip" value="<?=$clientdata->zip?>">
		...
		?>
				<div class="row">
					<div class="twelve columns">
						...
						<div class="three columns"><input type="text" value="<?= $row->catname ?>" name="catname" class="input-text small" ></div>

						<div class="four columns"><input type="text" value="<?= $row->catdescription ?>" name="catdesc" class="input-text" ></div>

						<div class="one column"><INPUT TYPE="IMAGE" SRC="/assets/images/icons/save-icon-32.png" ALT="Submit button"></div>
						<!--<img src="" onClick="$(this).addClone();">-->
						<div class="one column"><a href="/client/deleteCategory/<?= $row->idcategories;?>"><img src="/assets/images/icons/delete-icon-32.png"> </a></div>
				...
				<div class="row">
					<div class="twelve columns">
						...
						<div class="three columns"><input type="text" placeholder="Category Name" name="catname" value="" class="input-text small" ></div>

						<div class="four columns"><input type="text" placeholder="Category Description" name="catdesc" value="" class="input-text" ></div>
			...
			<?php endforeach; else: ?>
				<div class="row">
					<div class="twelve columns">
						...
						<div class="two columns"><input type="text" placeholder="Category Name" name="catname" value="" class="input-text small" ></div>
			...
			if (isset($results) && count($results) > 0):
				foreach($results as $row): ?>
					<div class="adminthumb" >
						<div class="deleteimage"><a href="/client/deletephoto/<?=$row->photo_id ?>"><img src="/assets/images/icons/delete-icon-32.png" alt="Delete Image"></a></div>
						<a href="<?=$row->fullsize ?>">
							<img src="<?=$row->thumb ?>" />
						</a>
		...
		<div class="row">
			<div class="twelve columns">
				<textarea name="content" id="pagededitor" ><p>Example data</p></textarea>
					...
					<?php if (isset($faqs) && count($faqs)>0): foreach($faqs->result() as $row): ?>
						<div class="row">
							...
							<div class="four columns">
								<textarea rows="2" cols="20" name="question" placeholder="Question: "><?= $row->question ?></textarea>
							</div>
							<div class="four columns">
